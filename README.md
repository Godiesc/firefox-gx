...
<p>You can also use the <b><a href="https://addons.mozilla.org/es/firefox/addon/firefox-color/">"Firefox Color"</a> </b>extension to change the accent color to your preference. To change the color go into the extension page: </p>
<ul><li>In "Custom colors" tab change the color in "Toolbar Color", select a black color to dark theme or select white to a light theme.</li>
