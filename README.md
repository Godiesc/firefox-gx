...
<p><b>You can also use the <href="https://addons.mozilla.org/es/firefox/addon/firefox-color/">Firefox Color</a> extension to change the accent color to your preference. To change the color go into the extension page: </b></p>
