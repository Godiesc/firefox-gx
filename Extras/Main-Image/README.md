...
<p><i>PD: The file <code>ogx_root-personal.css</code> will set the default values of the theme, if you changed some rule in the file you will need to change again in this new file. The wallpaper will be the named wallpaper1.png, if you want to change it you will need to replace your new image with that name.</i></p>
