...
<p><i>PD: The file <code>ogx_root-personal.css</code> will set the default values of the theme, if you change some rule in this file you will need to change again in this new file.</i></p>
